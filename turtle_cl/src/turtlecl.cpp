...
namespace turtle_cl
{
    ...
    nh_private_(ros::NodeHandle("~"))
  {
    ...
    goal_pose_subscriber = nh_.subscribe<geometry_msgs::Pose>
                          ("/goal_pose",1,&turtleCL::goalCallback, this);
  ...
  void turtleCL::goalCallback(const geometry_msgs::PoseConstPtr &msg)
  {
